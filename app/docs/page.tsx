    ...
    <main className="min-h-screen bg-[#f5f7f9] px-5 py-10 text-slate-900 sm:px-10">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_14px_45px_rgb(15_23_42/5%)] sm:p-8">
          <section><h2 className="text-lg font-semibold text-[#102b3d]">How it works</h2><ol className="mt-3 list-decimal space-y-2 pl-5 text-sm leading-6 text-slate-600"><li>Select a country and region loaded from the active POTA CSV catalog.</li><li>Fetch active parks from the POTA CSV and use Overpass only to detect existing <code>communication:amateur_radio:pota=&lt;POTA reference&gt;</code> entities.</li><li>Search public OSM Photon results first, falling back to Nominatim when needed, with partial and fuzzy matching that prioritizes ways and relations.</li><li>Inspect candidates in OSM, then approve at most one candidate per POTA park.</li><li>Download an OsmChange file containing only approved modifications.</li></ol></section>
